...
export const brToday = (): string => new Date().toLocaleDateString('en-CA', { timeZone: BR_TZ })

export const utcDateStr = (value: Date | string): string => new Date(value).toISOString().slice(0, 10)
