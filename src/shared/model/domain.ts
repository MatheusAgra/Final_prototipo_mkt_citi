...
export interface CalendarEvent {
  ...
  attendees: {
    ...
    attendanceStatus: "PRESENTE" | "AUSENTE" | "ATRASADO" | null
  }[]
}
...
export const initialKanban: KanbanColumn[] = [
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Post carrossel — Cases de sucesso",
        channel: "linkedin",
        assignees: [{ memberId: 2, note: 4.5 }],
        priority: "alta",
        difficulty: "médio",
        dueDate: "2026-08-05",
      },
      {
        id: "t2",
        title: "Newsletter agosto — Tendências Q3",
        channel: "email",
        assignees: [
          { memberId: 3, note: 4.0 },
          { memberId: 2, note: 4.2 },
      ...
      {
        id: "t3",
        title: "Artigo SEO — Marketing B2B 2026",
        channel: "site",
        assignees: [{ memberId: 4, note: 4.8 }],
        priority: "baixa",
        difficulty: "difícil",
        dueDate: "2026-08-12",
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t4",
        title: "Reels — Lançamento Produto Q3",
        channel: "instagram",
        assignees: [
          { memberId: 3, note: 4.5 },
          { memberId: 4, note: 3.8 },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t6",
        title: "Carrossel — 5 dicas de produtividade",
        channel: "instagram",
        assignees: [{ memberId: 4, note: 4.6 }],
        priority: "média",
        difficulty: "médio",
        dueDate: "2026-08-01",
      },
      {
        id: "t7",
        title: "Email Black November — Oferta especial",
        channel: "email",
        assignees: [{ memberId: 3, note: null }],
        priority: "alta",
        difficulty: "fácil",
        dueDate: "2026-07-31",
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t8",
        title: "Story — Bastidores da equipe",
        channel: "instagram",
        assignees: [{ memberId: 2, note: 4.0 }],
        priority: "baixa",
        difficulty: "fácil",
        dueDate: "2026-07-30",
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t9",
        title: "Post Q2 Results — LinkedIn",
        channel: "linkedin",
        assignees: [{ memberId: 2, note: 4.7 }],
        priority: "alta",
        difficulty: "médio",
        dueDate: "2026-07-25",
      },
      {
        id: "t10",
        title: "Campanha Julho — Instagram Grid",
        channel: "instagram",
        assignees: [
          { memberId: 3, note: 4.9 },
          { memberId: 2, note: null },
        ],
        priority: "alta",
        difficulty: "difícil",
        dueDate: "2026-07-20",
...
export const postsData: Post[] = [
  {
    ...
    images: [
      ...
      {
        url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
      {
        url: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
    ],
    caption:
      "O mercado B2B está mudando rapidamente. Separamos as 5 estratégias que estão gerando mais resultado em 2026...\n\n✅ Account-Based Marketing\n✅ SEO técnico para decisores\n✅ LinkedIn Thought Leadership\n✅ Email nurturing segmentado\n✅ Cases de sucesso em vídeo\n\nQual você já aplica? 👇\n\n#MarketingB2B #EstrategiaDigital",
    format: "carousel",
    insights: {
      likes: 238,
      reach: 4820,
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
      {
        url: "https://images.unsplash.com/photo-1556761175-4b46a572b786?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
    ],
    caption:
      "Vai, vai, vai! 🚀 Tá chegando!\n\nQ3 chegando com novidades que vão transformar sua gestão de marketing. Fica ligado! 👀\n\n#Lançamento #MarketingDigital",
    format: "reel",
    insights: {
      likes: 940,
      reach: 12400,
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1543286386-713bdd548da4?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
      {
      ...
      {
        url: "https://images.unsplash.com/photo-1553484771-371a605b060b?w=400&h=400&fit=crop&auto=format",
        tipo: "imagem",
      },
    ],
    caption:
      "Content marketing gera 3x mais leads com 62% menos custo.\n\n📊 +340% tráfego orgânico · 127 MQLs · CAC -28%\n\n#ContentMarketing #ROI",
    format: "document",
    insights: {
      likes: 351,
      reach: 6230,
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1586339949916-3e9457bef6d3?w=600&h=200&fit=crop&auto=format",
        tipo: "imagem",
      },
    ],
    caption:
      "Assunto: 🔥 As 3 tendências de marketing que vão dominar agosto\n\nOlá [Nome],\nEste mês trouxemos análises e insights exclusivos...",
    format: "article",
    insights: {
      likes: 0,
      reach: 2840,
...
export const materialsData: Material[] = [
  ...
  },
  {
    ...
    cover:
      "https://images.unsplash.com/photo-1611944212129-29977ae1398c?w=400&h=250&fit=crop&auto=format",
    downloads: 843,
...
export const defaultMetrics: CustomMetric[] = [
  {
    id: "m1",
    name: "Taxa de Engajamento IG",
    value: 3.8,
    unit: "%",
    formula: "(Curtidas + Comentários + Saves) / Alcance × 100",
    channel: "instagram",
    color: "#E1306C",
  },
  {
  ...
  {
    id: "m3",
    name: "Taxa de Abertura Email",
    value: 28.4,
    unit: "%",
    formula: "Emails Abertos / Emails Enviados × 100",
    channel: "email",
    color: "#FFB300",
  },
  {
    ...
    value: 28,
    unit: "leads",
    formula: "Contagem manual de leads com score ≥ 65 no período",
    color: "#00E5C8",
  },
  {
    id: "m5",
    ...
    value: 8240,
    unit: "sessões",
    formula: "Soma de sessões via busca orgânica (Google Analytics)",
    channel: "site",
    color: "#00C853",
  },
]
...
export const defaultSEO: SEOState = {
  ...
  topKeywords: [
    {
      keyword: "gestão de marketing",
      position: 4,
      volume: 1900,
      difficulty: 62,
    },
    {
      keyword: "marketing b2b estratégia",
      position: 7,
      volume: 880,
      difficulty: 45,
    },
    {
      keyword: "plataforma marketing digital",
      position: 12,
      volume: 590,
      difficulty: 58,
    },
    ...
    {
      keyword: "métricas instagram empresa",
      position: 9,
      volume: 1200,
      difficulty: 51,
    },
